...
sc_example_counts <- data.matrix(read.csv("GSE46226_SC_Expression.csv", header = T, row.names = 1))
...
params1 <- setParams(params, update = list( nGenes = 1000, mean.rate = 0.1, mean.shape = 0.31))
params2 <- setParams(params, update = list( nGenes = 1000, mean.rate = 0.2, mean.shape = 0.33))
params3 <- setParams(params, update = list( nGenes = 1000, mean.rate = 0.3, mean.shape = 0.37))
...
sim.path1 <- splatSimulatePaths(params1,  verbose = FALSE)
sim.path2 <- splatSimulatePaths(params2,  verbose = FALSE)
sim.path3 <- splatSimulatePaths(params3,  verbose = FALSE)
